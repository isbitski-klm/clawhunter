...
- **Follow responsible disclosure best practices.** If ClawHunter finds vulnerabilities in third-party software, report them through the maintainer's preferred channel (security.txt, vulnerability database, direct contact). Don't publish exploit details publicly without coordination. For federal and government-adjacent programs, follow [NIST SP 800-216](https://csrc.nist.gov/pubs/sp/800/216/final) (Coordinated Vulnerability Disclosure: A Strategic Framework) as a reference for structured, responsible reporting.
